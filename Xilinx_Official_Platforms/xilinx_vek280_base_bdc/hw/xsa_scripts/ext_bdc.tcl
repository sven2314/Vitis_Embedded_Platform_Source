...
proc create_root_design { parentCell } {
  ...
  set LPDDRNoc0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_noc:1.1 LPDDRNoc0 ]
  set_property -dict [list \
    CONFIG.NUM_CLKS {0} \
    CONFIG.NUM_MI {0} \
    CONFIG.NUM_NMI {4} \
  ...
  set LPDDRNoc1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_noc:1.1 LPDDRNoc1 ]
  set_property -dict [list \
    CONFIG.NUM_CLKS {0} \
    CONFIG.NUM_MI {0} \
    CONFIG.NUM_NMI {4} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT_REQUESTED_OUT_FREQUENCY {104.167,156.25,312.5,78.125,208.33,416.67,625.000} \
