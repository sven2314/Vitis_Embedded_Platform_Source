...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
    CONFIG.DATA_WIDTH {128} \
    CONFIG.CONNECTIONS { M00_INI { read_bw {5} write_bw {5}} M04_INI { read_bw {5} write_bw {5}}} \
    CONFIG.DEST_IDS {} \
  ...
  connect_bd_intf_net -intf_net icn_ctrl_2_M00_AXI [get_bd_intf_pins icn_ctrl_2/M00_AXI] [get_bd_intf_pins to_delete_kernel_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net icn_ctrl_3_M00_AXI [get_bd_intf_pins icn_ctrl_3/M00_AXI] [get_bd_intf_pins to_delete_kernel_ctrl_1/S_AXI]
  connect_bd_intf_net -intf_net icn_ctrl_4_M00_AXI [get_bd_intf_pins icn_ctrl_4/M00_AXI] [get_bd_intf_pins to_delete_kernel_ctrl_2/S_AXI]
  connect_bd_intf_net -intf_net icn_ctrl_5_M00_AXI [get_bd_intf_pins icn_ctrl_5/M00_AXI] [get_bd_intf_pins to_delete_kernel_ctrl_3/S_AXI]
  ...
  connect_bd_net -net psr_100mhz_peripheral_aresetn [get_bd_pins axi_intc_cascaded_1/s_axi_aresetn] [get_bd_pins axi_intc_parent/s_axi_aresetn] [get_bd_pins icn_ctrl_1/aresetn] [get_bd_pins icn_ctrl_2/aresetn] [get_bd_pins icn_ctrl_3/aresetn] [get_bd_pins icn_ctrl_4/aresetn] [get_bd_pins icn_ctrl_5/aresetn] [get_bd_pins psr_100mhz/peripheral_aresetn] [get_bd_pins to_delete_kernel_ctrl_0/aresetn] [get_bd_pins to_delete_kernel_ctrl_1/aresetn] [get_bd_pins to_delete_kernel_ctrl_2/aresetn] [get_bd_pins to_delete_kernel_ctrl_3/aresetn]
